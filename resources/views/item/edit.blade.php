    ...
    <br>
        ...
        <form class="flex flex-col max-w-2xl mx-auto" action="{{ route('item.update', $item['id']) }}" method="POST"
            ...
            <div class="mt-4">
                ...
                <x-text-input value="{{ $item['description'] }}" id="description" class="block mt-1 w-full" type="text"
            ...
            <div class="mt-4">
                ...
                <x-text-input value="{{ $item['price'] }}" id="price" class="block mt-1 w-full" type="number"
                    name="price" required />
            ...
            <div class="mt-4">
                ...
                <select id="category" name="category"
                    ...
                    <option value="noodle" {{ $item['category'] == 'noodle' ? 'selected' : '' }}>Noodle</option>
            ...
            <div class="mt-4">
                ...
                <img src="{{ asset('storage/' . $item['image']) }}" class="w-40 h-40 mb-4 object-cover rounded-lg"
                    alt="previous image" />
                <input
